...
export async function POST(req: NextRequest) {
  ...
  // License key creation disabled to allow deployment
  console.log('Stripe webhook received - would create license key:', { key, tier, email });

  // Email the key via Resend REST API (not SDK)
